<?php
    ...
    // $result_rq_all = $userdata_rq->rq_all();
    // // $result_user_all = $userdata_user->user_all();
    // $num = mysqli_fetch_array($result_rq_all);
    // if ($num > 0) {
    //     $num_id_rq = $num['num_id_rq'];
    //     $objective_rq = $num['objective_rq'];
    //     $num_passengers = $num['num_passengers'];
    //     $date_go_rq = $num['date_go_rq'];
    //     $date_back_rq = $num['date_back_rq'];
    //     $pho_rq = $num['pho_rq'];
    //     $email_rq = $num['email_rq'];
    // } 
...
<body>
    <div class="container">
        ...
        <a href="formcar.php" class="btn btn-primary">เพิ่มข้อมูลรถ</a>
